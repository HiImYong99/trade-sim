...
function interpolate(points: [string, number][]): Record<string, number> {
  ...
  for (let i = 0; i < sorted.length - 1; i++) {
    ...
    for (let m = 0; m <= totalMonths; m++) {
      ...
      result[key] = Math.round(startPrice + (endPrice - startPrice) * ratio);
    }
  }
  return result;
}
...
export const ASSETS: Asset[] = [
  ...
  },
  {
    ...
    prices: interpolate([
      ['2015-01', 18],  ['2016-01', 25],
      ['2017-01', 106], ['2018-01', 240],
      ['2019-01', 137], ['2020-01', 240],
      ['2021-01', 530], ['2022-01', 270],
      ['2022-10', 120], ['2023-01', 150],
      ['2023-06', 420], ['2023-12', 495],
      ['2024-03', 880], ['2024-06', 1200],
      ['2024-09', 1160], ['2024-12', 1350],
      ['2025-03', 1100], ['2025-06', 1400],
    ]),
  },
  {
